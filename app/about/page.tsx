...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Meet Cristian González Rivera, founder of SparkRise AI — based in Northern Virginia, building AI lead automation and reactivation systems for med spas nationwide.",
    ...
    images: [
      {
        ...
        width: 480,
        height: 560,
        alt: "Cristian González Rivera, Founder of SparkRise AI",
      },
    ],
  },
  twitter: {
            ...
            <div>
              ...
              <div className="mt-8 space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  father, and problem-solver at his core. Now based in Northern Virginia (Loudoun County),
                  he built SparkRise AI out of a genuine obsession with figuring out how things work —
                  and an even stronger drive to make those things useful for real people running real businesses.
                </p>
                <p>
                ...
                <p>
                  That depth is what separates SparkRise from the noise. Cristian specializes in
                  AI automation for med spas — bridging the gap between fast-moving technology and
